...
const Blog = () => (
  <div className="blogEntry">
    ...
    >
      ...
      >
        <p>
          ...
          <br />
          <br />
          it's not my first time here, and i'm not sure there'll be a last. i've
          had multiple people tell me, with some surprise in their voices, that
          i go here quite often. That it seems like i'm always here.
          <br />
          <br />
          the horizon cracks and gives way to golden, rolling hills, each
          raising and lowering our car alternately, like lazy waves, churning
          slowly.
          <br />
          <br />
          can you blame me?
    ...
    <div className="photo">
      ...
      >
        <p>
          between breaths i wonder about nothing. the shutter on my camera fails
          and comes back to life in the same moment.
        </p>
      </div>
    </div>
    ...
    <div className="photo inset">
      ...
      >
        <p>
          ...
          <br /> <br />
          i'd've had to left some people here, leave some things behind. i'd've
          had to plant new seeds, and hope they'd grow, and i'd have to check
          in, and call, just to keep loved ones close, and watch less loved ones
          go,
          <br /> <br />
          the time between calls getting longer, the messages left read getting
          older.
        </p>
      </div>
    </div>
    ...
    <div className="photo" style={{marginLeft: 600}}>
      ...
      >
        <p>
          you live two blocks from here. it's the fourth time i've been by and
          not said hello. it's just, i'm busy, and you're busy, even though i
          think we both have time, just that just because i'd do anything with
          you,
          <br /> <br />
    ...
    <div className="photo">
      ...
      >
        <p>
          ...
          watching these things change, swirling around me, just new, new, new,
          fighting for meaning, rootless changes dying to be made sense of.
          <br />
          <br />
          instead, i'm watching myself change up close, placed somewhere between
          these unmoving hills,
          <br /> <br />
